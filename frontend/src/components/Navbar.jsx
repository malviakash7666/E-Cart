...
const Navbar = () => {
  ...
  return (
    <div className='flex   items-center justify-between py-5 font-medium'>
        <Link to={"/"}>
<h1 onClick={()=>navigate("/")} className="text-3xl text-black">ShopEase</h1>
</Link>
<ul className=" hidden sm:text-sm  sm:flex gap-5 text-sm text-gray-700">
    ...
    <NavLink to={import.meta.env.VITE_ADMIN_URL} target='_blank' className='flex flex-col items-center gap-1 ' >
        <p>Admin</p>
        <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
