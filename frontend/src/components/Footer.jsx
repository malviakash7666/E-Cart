...
<h1 onClick={()=>navigate("/")} className="text-3xl ">ShopEase</h1>
            ...
            <p className='w-full md:w-1/2 text-gray-600 '>Shopease brings you a smooth and reliable online shopping experience with quality product at honest prices. Our mission is to make shopping simple, fast, and secure for everyone.</p>
        </div>
<div >
