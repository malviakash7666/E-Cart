    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col  justify-center gap-6 md:w-2/4 text-gray-600">
          <p>Our mission is to provide customers with an online shopping experience that is simple, reliable, and completely secure. We believe everyone deserves high-quality product at fair prices, and our team works every day to deliver exactly that — from fast delivery to easy returns and dedicated customer support.</p>
          <p>We started this e-commerce store with a simple idea — to make quality product accessible to everyone. Since day one, our focus has been on trust, quality, and customer satisfaction. Because of this commitment, we are becoming the first choice of thousands of customers.</p>
          <b className="text-gray-600">Our Mission</b>
          <p>Our mission is to make online shopping simple, trustworthy, and accessible for everyone. We aim to deliver high-quality product at fair prices while ensuring a smooth, secure, and enjoyable shopping experience. Customer satisfaction guides every decision we make.</p>
        </div>
      </div>
